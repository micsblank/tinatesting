...
blocks:
  - background: bg-yellow-50/80
    headline: >-
      Welcome To Your
      Sanctuary?./,nmbhjyiuh.kjbhgcfdrytutliyuh.kjbfxgdrytkulihkjb
    tagline: BONDI’S FIRST INFRARED HEATED STUDIO
    _template: hero
  ...
  - background: bg-green-50/80
    ...
    actions:
      - label: Get Started
        ...
        link: /about
    image:
      src: /uploads/4F98A6FE-41CE-4706-A0DC-FB5858FC0FC9_4_5005_c.jpeg
      alt: Bondi image
      videoUrl: ''
    _template: hero
  - background: bg-cyan-50/80
